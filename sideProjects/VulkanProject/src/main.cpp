...
private:
    ...
    void createTextureImage() {
        ...
        stbi_uc* pixels = stbi_load("../textures/xpos.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
    ...
    void createCommandBuffers() {
        ...
        for (size_t i = 0; i < commandBuffers.size(); i++) {
            ...
            vkCmdDrawIndexed(commandBuffers[i], static_cast<u32>(indices.size()), 1, 0, 0, 0);
